...
Project Structure
AirCanvas ┣ air_canvas.py # Main application script ┣ README.md # Project documentation
...
A webcam window will open. Move your colored marker in front of the camera to start drawing.
Controls
